...
namespace Elan
{
    ...
    {
        public static void DoubleBuffered(Control dgvControl, bool bSetting)
        {
            Type cDataGrideViewType = dgvControl.GetType();
            PropertyInfo cPropertyInfo = cDataGrideViewType.GetProperty("DoubleBuffered", BindingFlags.Instance | BindingFlags.NonPublic);
            cPropertyInfo.SetValue(dgvControl, bSetting, null);
        }
    }
    ...
    public class UserInterfaceDefine
    {
        ...
        public const int m_nOffset_RawData_Index = 0x00;
        public const int m_nMMTPGA_RawData_Index = 0x07;
        ...
        /// </summary>
        public static Color[] m_clrCompensatedColor_Array = 
        { 
            Color.Black, 
            Color.Red,
            Color.LightGreen,
        ...
        public const int m_nDefaultBackgroundColor = 0x00faff;//Color.FromArgb(0, 250, 255)
        public const int m_nFinger_1_Color = 0xff0000;//Red, Green, Blue 
        public const int m_nFinger_2_Color = 0x0080ff;
        public const int m_nFinger_3_Color = 0x008040;
        public const int m_nFinger_4_Color = 0xff0080;
        public const int m_nFinger_5_Color = 0xff8000;
        public const int m_nFinger_6_Color = 0x004080;
        public const int m_nFinger_7_Color = 0x00ff80;
        public const int m_nFinger_8_Color = 0x808040;
        public const int m_nFinger_9_Color = 0x400000;
        public const int m_nFinger_10_Color = 0x0000ff;
        ...
        //J2++
        public const int m_nDEFAULT_FINGER_OSR = 64;
        public const int m_nDEFAULT_PEN_OSR = 256;
        //J2--
        ...
        public const int m_nMAX_CCVPDDATA_LENGTH = 2;
        ...
        public const int m_nDELAY_TIME_PER_FRAME = 10; //10ms
        public const string m_sDEFAULT_EMPTY_DEVPATH = "NoTouch Device";

        public const int m_nMAX_CHAR_VALUE = 26;
    }//UserInterfaceDefine
}