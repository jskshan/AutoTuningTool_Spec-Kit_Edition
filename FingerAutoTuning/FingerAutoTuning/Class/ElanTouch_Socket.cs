...
//using Elan_TouchPad_Innovation;
using System.Windows.Forms;
using System.IO;

namespace Elan
{
    public class ElanTouch_Socket
    {
        ...
        public static string m_sDLLPath = "LibTouch_Socket.dll";
        ...
        /// <returns></returns>
        public static bool ContainSelf(ElanTouch_Socket.TraceMode Mode)
        {
            if ((Mode & ElanTouch_Socket.TraceMode.Self) != 0 || 
                (Mode & ElanTouch_Socket.TraceMode.ComboSelf) != 0 || 
                (Mode & ElanTouch_Socket.TraceMode.Combo2Self) != 0)
                return true;
            else
                return false;
        }
        ...
        /// <returns></returns>
        [DllImport("LibTouch_Socket.dll", SetLastError = true)]
        ...
        [DllImport("LibTouch_Socket.dll", SetLastError = true)]
        public static extern int GetSensorID(ref int nValue, ushort nAddr, int nTimeoutMS = 1000, int nDevIdx = 0);
