...
namespace Elan
{
    public class ElanDefine
    {
...
#if _USE_9F07_SOCKET
        public const int DEFAULT_SOCKET_PORT_9F07 = 12345;
#endif
        ...
        //J2--
        public const int DEFAULT_SPI_CMD_LENGTH = 0x06;
        ...
        /// </summary>
        /// <param name="nSelectInterfaceIndex"></param>
        /// <returns></returns>
        public static int GetInterfaceID(int nSelectInterfaceIndex)
        {
            if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_USB)
                return INTERFACE_USB;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_HID_OVER_I2C_TP ||
                     nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_HID_OVER_I2C_PoTP)
                return INTERFACE_HIDoverI2C;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_I2C ||
                     nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_I2C_TDDI)
                return INTERFACE_I2C;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_SPI_MA_RISING_HALF_CYCLE)
                return INTERFACE_SPI_MA_RISING_HALF_CYCLE;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_SPI_MA_FALLING_HALF_CYCLE)
                return INTERFACE_SPI_MA_FALLING_HALF_CYCLE;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_SPI_MA_RISING)
                return INTERFACE_SPI_MA_RISING;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_SPI_MA_FALLING)
                return INTERFACE_SPI_MA_FALLING;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_SPI_PRECISE)
                return INTERFACE_ITOUCH;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_TDDI_SPI_MA_RISING_HALF_CYCLE)
                return INTERFACE_TDDI_SPI_MA_RISING_HALF_CYCLE;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_TDDI_SPI_MA_FALLING_HALF_CYCLE)
                return INTERFACE_TDDI_SPI_MA_FALLING_HALF_CYCLE;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_TDDI_SPI_MA_RISING)
                return INTERFACE_TDDI_SPI_MA_RISING;
            else if (nSelectInterfaceIndex == (int)UserInterfaceDefine.InterfaceType.IF_TDDI_SPI_MA_FALLING)
